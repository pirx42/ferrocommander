...
//!
//! **The overlay is the shell's job, not `fc-core`'s.** The settings file
...
/// table in `fc-core` is: renaming a variant would otherwise silently change
