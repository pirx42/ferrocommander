...
use fc_core::compare::{compare, Comparison, Verdict};
use fc_core::vfs::LocalFs;
use tempfile::TempDir;

fn written(dir: &TempDir, name: &str, bytes: &[u8]) -> fc_core::vfs::VfsPath {
...
fn text_over_the_ceiling_gets_a_verdict_rather_than_a_stall() {
    ...
    let big = "a".repeat(fc_core::compare::CEILING_BYTES as usize + 1);
